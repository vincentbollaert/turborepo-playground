      ...
      {activeTab === 'learnings' && (
        <div className={styles.learnings}>
          ...
          <p>
            ...
            what you&apos;re left with is markup that makes no sense and cannot be debugged easily via dev tools.
          </p>
          <p>
            Utility classes are a useful addition when used for utility purposes — (spacing, theming, etc.). But when
            used to style everything, they severely impact your ability to productively maintain and scale your frontend
            codebase.
          </p>
          ...
          <ul>
            <li>
              the latest version of ESlint isn&apos;t backwards compatible and drastically changes the way you write
              your configs
            </li>
          ...
          <p>
            ...
            before the browser can render your React components.
          </p>
          <p>
            The additional complexity and build steps required during development meant that, in my case, serving
            packages as-is reduced compile time from a couple seconds to instant
          </p>
        </div>
      )}
    </>
