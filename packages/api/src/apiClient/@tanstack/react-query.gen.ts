...
import { type Options, getFeatures, postFeatures, deleteFeaturesById } from "../sdk.gen";
...
export const postFeaturesMutation = (options?: Partial<Options<PostFeaturesData>>) => {
...
export const deleteFeaturesByIdMutation = (options?: Partial<Options<DeleteFeaturesByIdData>>) => {
  const mutationOptions: UseMutationOptions<
    unknown,
    DefaultError,
